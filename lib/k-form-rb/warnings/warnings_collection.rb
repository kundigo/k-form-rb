    ...
    module WarningCollection
      ...
      def self.included(klass)
        ...
        klass.define_method :active_model_valid? do |context = nil|
          ...
          ### STEP 1 - clear warnings
          warnings.clear

          ### STEP 2 - override the `errors` method to that it points to the `warnings`
          def self.errors
            warnings
          end
          ### STEP 3 - run the warning validations

          _run_validate_warnings_callbacks
          ...
          ### STEP 5 - continue with the original flow
          errors.clear
          run_validations!
        ensure
